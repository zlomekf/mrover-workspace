...
SearchStateMachine::SearchStateMachine(StateMachine* roverStateMachine, Rover* phoebe,  const rapidjson::Document& roverConfig )
    :roverStateMachine( roverStateMachine ), phoebe( phoebe ), roverConfig( roverConfig ) {}
